...
const ZiWei = (function () {
  ...
  function renderIztro(astrolabe, gender, tst) {
    ...
    window._toggleFlyingStar = function(el, idx) {
      ...
      // 飞星四化入宫解读 (4化 × 12目标宫 = 48条)
      var flyInterp = {
        '化禄': {
          '命宫':'福气汇聚于自身，为人乐观有亲和力，做事顺遂得人缘。',
          '兄弟':'福气流向朋友兄弟，与手足朋友互动中获利，合作有益。',
          '夫妻':'福气流向感情婚姻，配偶带来好运，婚姻生活美满。',
          '子女':'福气流向子女桃花，子女缘佳，投资有利，桃花运好。',
          '财帛':'福气流向财运，赚钱顺利，财源广进，理财有道。',
          '疾厄':'福气流向健康，身体底子好，有病也容易痊愈。',
          '迁移':'福气流向外出，在外发展顺利，贵人多在远方。',
          '仆役':'福气流向人脉交际，朋友圈质量高，下属得力。',
          '官禄':'福气流向事业，工作顺风顺水，升迁有望。',
          '田宅':'福气流向家庭不动产，居住环境好，置产有利。',
          '福德':'福气流向精神世界，内心充实快乐，享福运好。',
          '父母':'福气流向长辈学业，与父母关系好，学业顺利。'
        },
        '化权': {
          '命宫':'掌控力集中在自身，个性强势有主见，领导力强。',
          '兄弟':'掌控力投向朋友圈，在兄弟朋友中有话语权和领导地位。',
          '夫妻':'掌控力投向感情，在婚姻中较主导，配偶能力也强。',
          '子女':'掌控力投向子女教育，对子女要求严格。投资上敢于决断。',
          '财帛':'掌控力投向财务，赚钱有魄力有手段，理财能力强。',
          '疾厄':'掌控力投向健康，身体强壮有力，但也容易逞强过劳。',
          '迁移':'掌控力投向外部世界，在外有影响力，社交中强势主导。',
          '仆役':'掌控力投向下属人脉，善于管理团队，朋友听你的。',
          '官禄':'掌控力投向事业，事业心极强，工作中有实权，升迁快。',
          '田宅':'掌控力投向家庭，在家说了算，置产投资果断。',
          '福德':'掌控力投向精神世界，内心有主见不随波逐流。',
          '父母':'掌控力投向长辈关系，与父母互动中你较主动。学业上自主。'
        },
        '化科': {
          '命宫':'名声贵人汇聚于自身，给人文雅高贵的印象，有学者气质。',
          '兄弟':'名声体现在朋友圈中，结交有文化修养的朋友。',
          '夫妻':'名声体现在婚姻中，配偶有学识涵养，感情文雅。',
          '子女':'名声体现在子女身上，子女聪明好学。桃花有气质。',
          '财帛':'名声带来财运，靠知识、口碑赚钱。赚钱方式体面。',
          '疾厄':'有病遇良医，健康问题能得到好的医治和关注。',
          '迁移':'在外有好名声，适合异地发展或学术交流。',
          '仆役':'在朋友中有好口碑，结交文雅之人。',
          '官禄':'事业上有名声，靠学识和专业立足。学术型事业有成。',
          '田宅':'居住环境优雅有品味，重视家居美学。',
          '福德':'精神世界充实高雅，有学术和文化追求。',
          '父母':'学业运极佳，读书考试顺利。与父母关系温文有礼。'
        },
        '化忌': {
          '命宫':'执念困扰集中在自身，容易自我纠结、压力大、想太多。需学会放下。',
          '兄弟':'执念困扰在兄弟朋友关系上，与朋友容易有矛盾纠葛，合伙需谨慎。',
          '夫妻':'执念困扰在感情婚姻上，对感情过于执着或焦虑。婚姻需要用心经营，防口角。',
          '子女':'执念困扰在子女方面，为子女操心多。投资容易亏损执迷不悟。',
          '财帛':'执念困扰在财运上，求财辛苦、容易破财或守不住钱。理财需格外小心。',
          '疾厄':'执念困扰在健康上，容易有慢性病或反复发作的问题。需重视体检和养生。',
          '迁移':'执念困扰在外出上，出门不顺、在外容易遇麻烦。社交中易有口舌是非。',
          '仆役':'执念困扰在人际上，容易遇到损友或被朋友拖累。识人不清。',
          '官禄':'执念困扰在事业上，工作压力大、事业发展遇阻碍。宜踏实不宜急进。',
          '田宅':'执念困扰在家庭不动产上，住所不安稳、房产纠纷。家庭关系需维护。',
          '福德':'执念困扰在精神上，内心焦虑不安、容易失眠多虑。需学会调节情绪。',
          '父母':'执念困扰在长辈学业上，与父母关系有压力。文书合同需仔细。'
        }
      };
